            ...
            <div class="card-body">
                <form action="../actions/product-actions.php" method="post" class="w-75 mx-auto">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md">
                            <label for="category" class="form-label small text-secondary text-white">Category</label>
                            <input type="text" name="category" id="category" class="form-control" value="<?= $product_details['category']?>">
                        </div>
                        <div class="col-md">
                            <label for="category" class="form-label small text-secondary text-white">Brand</label>
